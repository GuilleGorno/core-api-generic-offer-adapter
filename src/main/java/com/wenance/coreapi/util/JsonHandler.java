...
import com.wenance.coreapi.v1.exception.CannotParseObjectToJsonException;
import com.wenance.coreapi.v1.exception.JsonPropertyNotFoundException;
...
public class JsonHandler {
    ...
    public <T> String toJson(T object) {
        try {
            ...
            throw new CannotParseObjectToJsonException("Could not parse object of type " + object.getClass().getName() + " to json");
        }
    }
    ...
    public JsonNode toJsonNode(String json) {
        try {
            ...
            throw new CannotParseObjectToJsonException("Could not map json to JsonNode");
        }
    }
    ...
    public <T> T valueOf(JsonNode node, String property, Function<JsonNode, T> transf) {
        return Optional.ofNullable(node)
                ...
                .map(transf)
                .orElseThrow(() -> new JsonPropertyNotFoundException("Property [" + property + "] has not assigned value"));
    }
